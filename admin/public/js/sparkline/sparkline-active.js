(function ($) {
 "use strict";
	...
	var sparklineCharts = function(){
		 ...
		 $("#sparkline100").sparkline([34, 43, 43, 35, 44, 32, 44, 52], {
			type: 'line',
			width: '100%',
			height: '60',
			lineColor: '#1ab394',
		 ...
		 $("#sparkline26").sparkline([24, 43, 33, 55, 64, 72, 44, 22], {
			type: 'line',
			width: '100%',
			height: '60',
			lineColor: '#ed5565',
		...
		$("#sparkline27").sparkline([74, 43, 23, 55, 54, 32, 24, 12], {
			 type: 'line',
			 width: '100%',
			 height: '60',
			 lineColor: '#ed5565',
		 ...
		 $("#sparkline28").sparkline([24, 43, 43, 55, 44, 62, 44, 72], {
			type: 'line',
			width: '100%',
			height: '60',
			lineColor: '#1ab394',
		...
		$("#sparkline29").sparkline([74, 43, 23, 55, 54, 32, 24, 12], {
			type: 'line',
			width: '100%',
			height: '60',
			lineColor: '#ed5565',
		...
		$("#sparkline30").sparkline([24, 43, 43, 55, 44, 62, 44, 72], {
			type: 'line',
			width: '100%',
			height: '60',
			lineColor: '#1ab394',
